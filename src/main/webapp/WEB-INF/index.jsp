            ...
            <div class="row" align="right">
                ...
                <nav class="s-header__nav">
                    <ul>
                        ...
                        <li><a class="smoothscroll" href="login">Log In</a></li>
                    </ul>
                </nav>
                    ...
                    <div class="s-home__slide s-home__slide--1">
                        <div class="row">
                            <div class="column large-12 s-home__slide-text">
                                <h2>
                                    <span>Communicare Health</span>
                                </h2>
                                <p>
                                    The Communicare Health System is your new one stop shop for medication management,
                                    communication with your healthcare providers, and so much more. Take control of
                                    your health management.<br>
                                    This is the future. This is Communicare.
                                </p>
                            </div>
                        </div>
